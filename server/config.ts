...
export function saveConfig(patch: Partial<AppConfig>, options: { replaceInstances?: boolean } = {}): void {
  ...
  for (const key of ["xai", "anthropic", "openaiCompat", "composio", "box", "ruijieSandbox", "opencodeGo", "tts", "imageGen", "profile", "rooms", "threads", "localVm", "features", "budgets", "billing"] as const) {
